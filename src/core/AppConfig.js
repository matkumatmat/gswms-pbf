...
//   WEB_APP_URL: "https://script.google.com/macros/s/AKfycbxsJ6_3ajDsLjYKFKqwG_nuZxHAXzVi0-iwYUXKwTs/dev",
  ...
  EXTERNAL_API_PRODUCT_DETAIL:'https://script.google.com/macros/s/AKfycbwCYFD39K22lj4Z9xvVLitmMCLY2h46LEOLK83h9Nam33LacmaHKhhqPBZ8QsELF388/exec',

  DB_OLAP_DATA_ID: '1gj7a7zxc63cHYn5euAGFEioR07LRnxeqAicFPs5XqpQ', // Spreadsheet 'OLAP DATA'
  DB_OLAP_DATA_SHEET_NAME: 'OLAP_AGG',
  ...
  DB_ENVIRONTMENT:{
    DB_CONFIG_SETTING:{
        DB_CONFIG_SETTING_ID: 'NOT_SET_YET',
        DB_CONFIG_SETTING_SHEET_NAME: 'NOT_SET_YET',
        DB_CONFIG_SETTING_TABLE_NAME: 'NOT_SET_YET',
        DB_CONFIG_SETTING_START_ROW: 2,
        DB_CONFIG_SETTING_KEY_COL: 1,
        DB_CONFIG_SETTING_VALUE_COL: 2,
        DB_SALT_1_KEY: '1YV6SEg5Kd7rNHhoJquEqInZ6-DrTDKYwJZ4RGhBHJ0o',
        DB_SALT_2_KEY: '',
    },
    DB_USER_SETTING:{
        DB_USER_SETTING_ID: '1YV6SEg5Kd7rNHhoJquEqInZ6-DrTDKYwJZ4RGhBHJ0o',
        DB_USER_SETTING_SHEET_NAME: 'USER_SETTINGS',
        DB_USER_SETTING_TABLE_NAME: 'USER_LIST',
        DB_USER_SETTING_START_ROW: 2,
        COLS:{
                USER_UUID_ID_COL: 1,
                USER_ID_COL: 2,
                EMAIL_COL: 3,
  ...
  // MANAGEMENT LOGGING DATA
  DB_LOGGING: {
    DB_LOGGING_ID: '19ynIDMTX67ReGEjFHNCImuiVxY_oldB9L7DcmBDpE64',
    DB_LOGGING_SHEET_NAME: 'CHANGE_LOG',
    DB_LOGGING_TABLE_NAME: 'LOG',
    DB_LOGGING_START_ROW: 2,
    COLS: {
        ID_COL: 1,
        TIMESTAMP_COL: 2,
        USER_COL: 3,
  ...
  DB_PRODUCT_RECEIVING:{
    DB_PRODUCT_RECEIVING_ID:'17qOZOu3uEiYKCobZw2LlT7zEKrAN4QHzW-YbqiiJXjQ',
    DB_PRODUCT_RECEIVING_SHEET_NAME: 'RECEIVING_TRANSACTIONAL',
    DB_PRODUCT_RECEIVING_TABLE_NAME:'TRANSAKSIONAL',
    DB_PRODUCT_RECEIVING_START_COL:2,
    DB_PRODUCT_RECEIVING_ID_COL: 1,
    DB_PRODUCT_RECEIVING_RECEIVED_AT_COL:2,
    DB_PRODUCT_RECEIVING_UPDATED_AT_COL:3,
    DB_PRODUCT_RECEIVING_UPDATED_BY_COL:4,
    DB_PRODUCT_RECEIVING_RELATION_PRODUCT_ID_COL:5,
    DB_PRODUCT_RECEIVING_RELATION_BATCH_ID_COL:6,
